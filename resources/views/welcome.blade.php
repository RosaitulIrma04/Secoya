...
=======
>>>>>>> 1c9549fdde2c6a674e6c7b0f4c7a418851852050
</head>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 clearfix">
                        <div class="header-ctn">
                            ...
                            <div class="dropdown">
                                <div class="dropdown">
                                  <a href="{{ route('sindiran')}}" class="dropdown-toggle">
                                        ...
                                        <div class="product-widget">
                                            ...
                                            <div class="product-body">
                                                <h3 class="product-name"><a href="#">product name goes
                                                        here</a></h3>
                                                <h4 class="product-price"><span class="qty">1x</span>Rp 300.000
                                                </h4>
                                            </div>
                                            <button class="delete"><i class="fa fa-close"></i></button>
                                        </div>
